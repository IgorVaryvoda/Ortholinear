...
Need help with Ortholinear? [Open an issue](https://github.com/IgorVaryvoda/Ortholinear/issues) to contact the maintainer, Igor Varyvoda.

## Enable the keyboard

1. Open iOS Settings → General → Keyboard → Keyboards → Add New Keyboard.
2. Choose Ortholinear.
3. In a text field, use the globe to switch keyboards. Full Access is not needed.
...
[Privacy policy](PRIVACY.md) · [Setup and development](README.md)

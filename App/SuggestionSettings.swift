    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("English and Ukrainian suggestions run on your device; other layouts use the spell checker built into iOS. Tap an offered word to use it. Space and punctuation never accept a suggestion automatically. Between words, the row shows punctuation instead.")
            }
            Section("Fix a word") {
            ...
            Section("Teach it your words") {
                ...
                Text("The system keyboard also offers your text replacements and contact names from iOS. Words taught in the system keyboard stay there. The app preview has its own word list. Neither list needs Full Access or leaves your device.")
                    .foregroundStyle(.secondary)
            }
            Section {
